...
$actionType			= "PAY";
$cancelUrl			= SITE_URL."mentors/mentor_subcription_plan/cancel";	// TODO - If you are not executing the Pay call for a preapproval,
												//        then you must set a valid cancelUrl for the web approval flow
												//        that immediately follows this Pay call
$returnUrl			= SITE_URL."mentors/mentor_subcription_plan/success";
...
$receiverEmailArray	= array(
		'nishant_jain@mailinator.com',
		'shishir.sharma-facilitator@octalsoftware.net');
...
$receiverPrimaryArray = array(true,false);
...
$ipnNotificationUrl				= "";
$memo							= "Testing Octal";		// maxlength is 1000 characters
