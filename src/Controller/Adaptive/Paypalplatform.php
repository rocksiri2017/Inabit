<?php
 ...
 //session_start();
	...
	********************************************/
	...
	//------------------------------------
	/* $API_UserName = "pankaj.gupta-facilitator_api1.octalsoftware.net";
	$API_Password = "1364293672";
	$API_Signature = "Akr16tQJ5cOmDeeyM8pEQIHzoApIAR.BK6oBSB7gIYS63ni2s64U6akM"; */
	$API_UserName = "nishant_jain_api1.mailinator.com";
	$API_Password = "1402493370";
	$API_Signature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AMZxHQRwDZirDXYuMKBpiqO4z2vV"; 
	...
	*/
	function hash_call($methodName, $nvpStr)
	{
		...
		//echo $API_UserName;die('daassfsfdsf');
		//echo $API_Endpoint .= "/" . $methodName;
		//$API_Endpoint = "https://svcs.sandbox.paypal.com/AdaptivePayments/".$methodName;
		$API_Endpoint = 'https://svcs.sandbox.paypal.com/'.$methodName;
		...
		'X-PAYPAL-SECURITY-USERID: ' . 'nishant_jain_api1.mailinator.com',
		'X-PAYPAL-SECURITY-PASSWORD: ' .'1402493370',
		'X-PAYPAL-SECURITY-SIGNATURE: ' . 'AFcWxV21C7fd0v3bYYYRCpSSRl31AMZxHQRwDZirDXYuMKBpiqO4z2vV',
