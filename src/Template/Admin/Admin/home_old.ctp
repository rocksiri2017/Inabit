...
<div class="page animsition" style="animation-duration: 0.8s; opacity: 1;">
   <div class="page-header height-296 margin-bottom-30" style="background-image: url('http://imagine.emoceanlab.com.au/img/admin/dashboard2-header.jpg');">
			...
			<div class="panel"  style="min-height: 495px;">
				<header class="panel-heading">
					...
					<?php if(!empty($this->Shop->countProductPrice($value->id))){ ?>
							...
							<?php $totle += $this->Shop->countProductPrice($value->id); ?>                 
                  ...
                  <tbody>
					...
					<?php if(!empty($this->Shop->countProductPrice($value->id))){ ?>
						<tr>
							...
							<td>$<?php echo $this->Shop->countProductPrice($value->id) ?></td>                    
						</tr>
					<?php } ?>
					<?php } ?>
                  </tbody>
		...
		<div class="col-md-4">
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content" style="margin:0 0 0 0">
              <span class="info-box-text" style="padding-top: 24px; padding-bottom: 0px; padding-left: 16px;">OVERALL SALES</span>
              <span class="info-box-number"  style="padding: 11px 0px 24px 16px; font-size: 61px;"	>$<?php if(isset($overAllSale) && !empty($overAllSale)){  echo $overAllSale; }else{ echo '0'; } ?></span>
              <div class="progress" style="width: 90%; margin: 0px 0px 43px 29px;">
          ...
          <!-- /.info-box -->
			...
			<div class="info-box-content" style="margin:0 0 0 0">
			  <span class="info-box-text" style="padding-top: 24px; padding-bottom: 0px; padding-left: 16px;">TODAY SALES</span>
			  <span class="info-box-number" style="padding: 11px 0px 24px 16px; font-size: 61px;">$ <?php if(isset($todaySale) && !empty($todaySale)){  echo $todaySale;  }else{ echo '0';} ?></span>
				<div class="progress" style="width: 90%; margin: 0px 0px 43px 29px;">
