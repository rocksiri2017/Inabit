          ...
          <div class="panel">
            ...
            <div class="panel-body container-fluid">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group form-material">
                    ...
                    <select name="paypal_fees_type" class="form-control">
                      <option value="fixed" <?php if ($settings->paypal_fees_type == 'fixed') { echo 'selected="selected"'; } ?>>Fixed Rate</option>
                      <option value="percentage" <?php if ($settings->paypal_fees_type == 'percentage') { echo 'selected="selected"'; } ?>>Percentage</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group form-material">
                    <label class="control-label" for="inputText">Paypal Email</label>
                    <?= $this->Form->input('paypal_email', ['class' => 'form-control', 'label' => false]) ?>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group form-material">
                    ...
                    <select name="ezypay_fees_type" class="form-control">
					  ...
					  if($settings->ezypay_fees_type == 'fixed') { echo 'selected="selected"'; } ?>>Fixed Rate</option>
                      <option value="percentage" <?php if($settings->ezypay_fees_type == 'percentage') { echo 'selected="selected"'; } ?>>Percentage</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-6">
