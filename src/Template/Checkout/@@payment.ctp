...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                 <a class="mbr-buttons__btn btn btn-lg btn-info btn-green-transparent" href="<?= $this->Url->build(['controller' => 'cart', 'action' => 'pay_order', 'prefix' => false]) ?>" id="next_link_payment">Payment</a>
            </div>
        </div>
    </div>
