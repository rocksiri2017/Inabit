            ...
            <div class="typeahead-container">
                <div class="typeahead-field">
                    <span class="typeahead-query">
                        ...
                        <div class="input search"><input name="advanced_search[<?= $random; ?>][value]" id="search_product" class="search-query-multiple search-multiple-fields" placeholder="Search..." autocomplete="off" data-url="/search/typeahead" name="<?php echo $product->name ?>" type="search"></div>
