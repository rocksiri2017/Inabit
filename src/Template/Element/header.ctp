            ...
            <div class="mbr-navbar__container">
                    ...
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
                        ...
                        <?php if($this->request->session()->read('Auth.User') && ($this->request->session()->read('Auth.User.group_id') == 2)): ?>
                            <ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons-menu mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active">
                                ...
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'contact', 'action' => 'index', 'prefix' => false]) ?>">  <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('menu_contact_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
                                    </div>  Contact</a></li>
                                <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'cart', 'action' => 'index', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
									...
									<?php if(!empty($this->request->session()->read('Search.AdvancedSearchProduct'))){ ?> 
										<li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'search', 'action' => 'advanced',$this->request->session()->read('Search.AdvancedSearchProduct'),'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
										<?= $this->Html->image('shopping_list_icon_menu.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
										</div>  Shopping List</a></li>
									<?php } ?>		
                                ...
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'orders', 'action' => 'index', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('menu_order_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
                                    </div>  My Orders</a></li>
                        ...
                        <?php elseif($this->request->session()->read('Auth.User') && ($this->request->session()->read('Auth.User.group_id') == 3)): ?>
                            <ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons-menu mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active">
                                ...
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white" href="<?= $this->Url->build(['controller' => 'shop', 'action' => 'listings', 'prefix' => false]) ?>">  <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('cart_icon_menu.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?> 
                                    </div> My Shop</a></li>
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'contact', 'action' => 'index', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('menu_contact_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
                                ...
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'packages', 'action' => 'index', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('menu_package_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
                                    </div>  Packages</a></li>
									 <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'packages', 'action' => 'transaction', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('menu_pay_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
                                    </div>Transactions</a></li>
								<li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'user_notifications', 'action' => 'index', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
								<?= $this->Html->image('menu_notification_icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?>
								</div>  Notifications</a></li>									
                                <li class="mbr-navbar__item mg-l-sm"><a class="mbr-buttons__link btn text-white"  href="<?= $this->Url->build(['controller' => 'users', 'action' => 'logout', 'prefix' => false]) ?>"> <div class="row" style="margin-bottom:20px;">
                                    <?= $this->Html->image('signin-icon.png', ['class' => 'mbr-navbar__brand-img mbr-brand__img', 'alt' => \Cake\Core\Configure::read('Site.name'), 'title' => 'IN A BIT', 'height' > '80px']) ?> 
                ...
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline" style="float: left; margin-left: 55px;">
						<?php if($this->request->session()->read('Auth.User') && ($this->request->session()->read('Auth.User.group_id') != 5)): ?>	
							<span class="mbr-brand__logo">
								<a href="<?php echo $this->Url->build(['controller' => 'users', 'action' => 'account']); ?>">
