                                ...
                                <div class="row">
                                    <div class="container">
                                        <div class="col-md-12 text-center">
                                           ...
                                           <?php if(isset($v->package_upgrade->payment_status) && $v->package_upgrade->payment_status == "1"){ ?> 
										   
											<img src="img/tick-icon.png" class="img-responsive" style="margin: 0px auto; width: 50px; margin-top: 65px;">
										   
										   <?php }else{ ?> 
										   <p class="small-table" style="margin-top: 90px;">&nbsp;</p>   
										   <?php } ?>
                                            ...
                                            <p>loren ipsum, lorem ipsum</p>
                                            <h4 class="small-table" style="margin-top: 48px !important; line-height: 5px;"><strong>100% Support</strong></h4>
                                            <h4 class="small-table"><strong>FOR USERS</strong></h4>
