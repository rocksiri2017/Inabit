		...
		<div class="row addToCartContainer mgt-sm">
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-9 col-sm-9 col-xs-9">
			 ...
			 <div class="col-md-9 col-sm-9 col-xs-9">
              <a style="color:#000;" href="<?php echo $this->Url->build(['controller' => 'products', 'action' => 'feedback',$product->id]); ?>">Rate and Review product</a>
            </div>
          </div>
        </div>
        <div class="row">
...
<div class="panel-body-header3">
		...
		<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
			...
			<thead>			
				<th class=" col col-md-6 col-sm-6 col-xs-4 completed-filter btn-green-transparent">Feedback</th>
				<th class=" col col-md-4 col-sm-4 col-xs-4 completed-filter btn-green-transparent">User</th>
				<th class=" col col-md-6 col-sm-6 col-xs-6 completed-filter btn-green-transparent">Rating</th>
            </thead>
		</div>
	</div>
</div>
