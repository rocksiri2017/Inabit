      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
			...
			if($image &&  file_exists(WWW_ROOT . $image)) {
				echo $this->Html->image('http://' . $_SERVER['HTTP_HOST'].'/timthumb.php?src='.$product->hero.'&w=326&h=499&a=t',array('class'=>'img-responsive','style' => 'margin: 0px auto;'));
			}else{
				echo $this->Html->image('http://' . $_SERVER['HTTP_HOST'].'/timthumb.php?src='.'shop_logo.jpg'.'&w=326&h=499&a=t',array('class'=>'img-responsive','style' => 'margin: 0px auto;'));
			} 
			?>
        ...
        <div class="row product-general">
          <div class="col-md-12">
            ...
            <p class="text-left blue-color"><strong>$<?= number_format((float)$user_product->price, 2, '.', ''); ?></strong></p>
        ...
        <div class="row">
          <div class="col-md-12 content-product">
            <p class="black-color"><?= $product->tags; ?></p>
          </div>
        </div>
