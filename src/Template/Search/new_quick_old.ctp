<?php if(!empty($products->toArray()) && $products->toArray() > 0){ ?>
	...
	<div class="absolute_order_filters">
		<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
			...
			<thead>			
				...
				<th class=" sort_cls col col-md-6 col-sm-6 col-xs-6 completed-filter btn-green-transparent">Product Name</th>
...
<?php if($products->toArray()): ?>	
		<div>
			<?php foreach($products as $product): ?>
				...
				<div class='clickable-row' data-href="<?= $this->Url->build(['controller' => 'products', 'action' => 'view_detail_search', $product['product']['id'], 'prefix' => false]) ?>">
					...
					<div class="right_discribe">
						...
						<div class="content-product-list"><?= $product['product']['created']->format('d-m-Y') ?></div>
