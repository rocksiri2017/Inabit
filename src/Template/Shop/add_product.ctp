                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <?= $this->Form->input('content', ['type'=>'textarea','class' => 'form-transparent', 'label' => false, 'placeholder' => 'Describe your product...']) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <div class="form-group">
                                <?= $this->Form->input('tags', ['class' => 'form-transparent', 'label' => false, 'placeholder' => 'Product Tags...']) ?>
                            </div>
                        </div>
                    </div>
                </div>
