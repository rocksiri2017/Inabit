...
<body class="inabit_bg">
    <section class="content-2 simple col-1 col-undefined mbr-after-navbar" id="content5-77">
        <div class="container">
			...
			<div class="row">
                <div class="col-md-12">
                    <h3 class="text-center pd-l-lg pd-r-lg white-text">Paypal Payment Details</h3>
                    <div class="form-group">
                        <div class="col-md-10">
                            <div class="form-group">
                                <?= $this->Form->input('paypal_business_email', ['class' => 'form-transparent', 'label' => false, 'placeholder' => 'Paypal Business Account']) ?>
                            </div>                           
                        </div>
                    </div>
                </div>
